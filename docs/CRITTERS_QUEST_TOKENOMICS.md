...
> **Document Type:** Reference documentation for tokenomics and distribution
> 
...
## SOV Mining Protocol Economics

> **Note:** This protocol is built on ORE Protocol V2 infrastructure, but we refer to it as "SOV Mining" for the Critters Quest implementation.
...
*This is a reference document for understanding $QUEST tokenomics. For UI/website implementation details, see `CONTEXT.md` and `CQ-UI-STYLE-GUIDE.md`.*
